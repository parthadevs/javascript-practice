/*
=========================================
Festival Gate Flow Simulation
=========================================

Description:
This project simulates attendee flow through multiple festival entry gates
over a series of time ticks.

Each gate has:
- A unique identifier
- A maximum processing capacity per tick
- A queue of arriving attendees for each tick

Features:
- Processes attendees based on each gate's capacity.
- Detects overflow when arrivals exceed capacity.
- Reroutes overflow attendees to the next gate in a circular order.
- Tracks the total number of attendees processed by each gate.
- Prints a throughput summary after the simulation.

The simulation is executed separately for morning and night schedules.
*/
